...
export function TierGate({ requiredTiers, children, fallback, showUpgrade = true }: TierGateProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 text-center bg-card/50 rounded-lg border border-border">
      ...
      <p className="text-muted-foreground text-sm max-w-sm mb-4">
        This content is available for {requiredTiers.join(" or ")} members.
        Upgrade to unlock exclusive training materials.
      </p>
      {showUpgrade && (
